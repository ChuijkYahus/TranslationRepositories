...
物流网络（Logistics Networks）是以节点和频道为基础的物品、流体、能量物流模组。
...
服务端所有者可以在**节点访问**设置中值得谁可以使用其他玩家的节点网络。默认值为**团队**（**Teams**），即在FTB Teams存在时跟随该模组设置。**所有**（**All**）可让所有玩家访问。**友方**（**Allies**）则允许团队成员和友方FTB团队访问。不存在FTB Teams时，“团队”对应仅所有者，“友方”也不会额外允许其他玩家使用。
