...
卷轴可以存放在[帽子](^trickster:items/writing_casting/top_hat)中，方便获取，还能保证其安全。
...
不过，署过名的卷轴中可以注入1到8瓶隐秘魔力。隐秘魔力是一种特殊制剂，能给卷轴注入仅限单次使用的魔力。


融有魔力的卷轴可以直接施放，不会向施法者支取代价，但这么做会损毁卷轴。

;;;;;

单次使用的卷轴内部有一魔力储库。制作时放入的隐秘魔力份数乘以100，即为该储库的容量。
