...
With no extra components, the ray will destroy blocks completely. Installing a Harvest Extractor causes drops to be deposited into a connected Item Output.
